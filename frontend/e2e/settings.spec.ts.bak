...
test.describe('Settings Page', () => {
  ...
  test('should persist settings across page reloads', async ({ page }) => {
    ...
    // Fill settings
    await domainInput.fill('persistent.example.com');
    await tokenInput.fill('persistent-token-12345');
    
    // Reload page
    await page.reload();
    
    // Settings should be cleared (since backend persistence isn't implemented yet)
